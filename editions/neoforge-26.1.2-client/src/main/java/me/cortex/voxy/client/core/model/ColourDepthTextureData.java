...
public record ColourDepthTextureData(int[] colour, int[] depth, int width, int height, int hash) {
   ...
   public boolean equals(Object obj) {
      if (obj == null) {
         ...
         ColourDepthTextureData other = (ColourDepthTextureData)obj;
   ...
   public ColourDepthTextureData clone() {
      return new ColourDepthTextureData(
         Arrays.copyOf(this.colour, this.colour.length), Arrays.copyOf(this.depth, this.depth.length), this.width, this.height, this.hash
      );
   }
}
