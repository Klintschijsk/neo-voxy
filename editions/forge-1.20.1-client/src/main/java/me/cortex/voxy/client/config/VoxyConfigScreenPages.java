...
//? if 1.20.1 {
    ...
    public static List<OptionPage> pages() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, storage)
                        .setName(Component.translatable("voxy.config.general.lodBoundaryFade"))
                        .setTooltip(Component.translatable("voxy.config.general.lodBoundaryFade.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((s, v) -> s.enableLodBoundaryFade = v, s -> s.enableLodBoundaryFade)
                        .setImpact(OptionImpact.LOW)
                        .build()
                ).add(OptionImpl.createBuilder(int.class, storage)
                        .setName(Component.translatable("voxy.config.general.lodBoundaryFadeLength"))
                        .setTooltip(Component.translatable("voxy.config.general.lodBoundaryFadeLength.tooltip"))
                        .setControl(opt -> new SliderControl(opt, 8, 64, 1, v -> Component.literal(v + " blocks")))
                        .setBinding((s, v) -> s.lodBoundaryFadeLength = v, s -> s.lodBoundaryFadeLength)
                        .setImpact(OptionImpact.LOW)
                        .build()
                ).add(OptionImpl.createBuilder(int.class, storage)
                        .setName(Component.translatable("voxy.config.general.lodBoundaryInset"))
                        .setTooltip(Component.translatable("voxy.config.general.lodBoundaryInset.tooltip"))
                        .setControl(opt -> new SliderControl(opt, 8, 32, 1, v -> Component.literal(v + " blocks")))
                        .setBinding((s, v) -> s.lodBoundaryInset = v, s -> s.lodBoundaryInset)
                        .setImpact(OptionImpact.LOW)
                        .build()
                ).build());
